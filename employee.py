...
class Employee:
    def __init__(self,root):
        ...
        self.table=ttk.Treeview(table_frame,column=("dep","name","degi","email","address","married","dob","doj","idproofcomb","idproof","gender","phone","country","salary","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
# =========================Functions========================
    # Add data
    def add_data(self):
        if self.var_dep.get()=="" or self.var_name.get()=="" or self.var_degi.get()=="" or self.var_email.get()=="" or self.var_address.get()=="" or self.var_married.get()=="" or self.var_dob.get()=="" or self.var_doj.get()=="" or self.var_idproofcomb.get()=="" or self.var_idproof.get()=="" or self.var_gender.get()=="" or self.var_phone.get()=="" or self.var_country.get()=="" or self.var_salary.get()=="" or self.var_radio1.get()=="":
            messagebox.showerror('Error','All Fields are required')
        else:
            try:
                conn=mysql.connector.connect(host='localhost',user='root',password='8295351575Ij@',database='mydata')
                my_cursor=conn.cursor()
                my_cursor.execute('insert into employee values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',(self.var_dep.get(),self.var_name.get(),self.var_degi.get(),self.var_email.get(),self.var_address.get(),self.var_married.get(),self.var_dob.get(),self.var_doj.get(),self.var_idproofcomb.get(),self.var_idproof.get(),self.var_gender.get(),self.var_phone.get(),self.var_country.get(),self.var_salary.get(),self.var_radio1.get()))
                conn.commit()
                self.fetch_data()
                conn.close()
        ...
        if self.var_dep.get()=="" or self.var_name.get()=="" or self.var_degi.get()=="" or self.var_email.get()=="" or self.var_address.get()=="" or self.var_married.get()=="" or self.var_dob.get()=="" or self.var_doj.get()=="" or self.var_idproofcomb.get()=="" or self.var_idproof.get()=="" or self.var_gender.get()=="" or self.var_phone.get()=="" or self.var_country.get()=="" or self.var_salary.get()=="" or self.var_radio1.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host='localhost',user='root',password='8295351575Ij@',database='mydata')
                    my_cursor=conn.cursor()
                    my_cursor.execute('update employee set Department=%s,Name=%s,Designation=%s,Email=%s,Address=%s,Marital_Status=%s,Date_of_Birth=%s,Date_of_Joining=%s,ID_Type=%s,Gender=%s,Phone_No=%s,Country=%s,Salary=%s,Photo_Status=%s where ID_Proof=%s',(self.var_dep.get(),self.var_name.get(),self.var_degi.get(),self.var_email.get(),self.var_address.get(),self.var_married.get(),self.var_dob.get(),self.var_doj.get(),self.var_idproofcomb.get(),self.var_gender.get(),self.var_phone.get(),self.var_country.get(),self.var_salary.get(),self.var_radio1.get(),self.var_idproof.get()))
                else:
                    if not update:
                        return
                conn.commit()
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="" or self.var_name.get()=="" or self.var_degi.get()=="" or self.var_email.get()=="" or self.var_address.get()=="" or self.var_married.get()=="" or self.var_dob.get()=="" or self.var_doj.get()=="" or self.var_idproofcomb.get()=="" or self.var_idproof.get()=="" or self.var_gender.get()=="" or self.var_phone.get()=="" or self.var_country.get()=="" or self.var_salary.get()=="":
            messagebox.showerror('Error','All Fields are required')
        else:
            try:
                conn=mysql.connector.connect(host='localhost',user='root',password='8295351575Ij@',database='mydata')
